...
const Cart = () => {
  ...
  const handleCheckout = async () => {
    if ((isUserAuthenticated() as { admin: boolean; key: string; user?: undefined; }).user) {
    ...
    <Box sx={{ width: "100%" }}>
      ...
      >
        <Typography variant="h5" color="initial">
          {t("global.total")}: ${totalPrice.toFixed(2)}
        </Typography>
          ...
          return (
            <ListItem key={product.id}>
              <ListItemButton>
                ...
                <ListItemText className="custom-text-price">
